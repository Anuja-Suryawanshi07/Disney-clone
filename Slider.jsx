...
const Slider = () => {
  ...
  return (
    ...
    <div className='flex overflow-x-auto w-full px-16 py-16 scrollbar-hide scroll-smooth' ref={elementRef}>
      {movieList.map((item)=>(
        <img src={IMAGE_BASE_URL+item.backdrop_path}
        className='min-w-full md:h-[360px] object-left-top mr-5 rounded-md hover:border-[4px] border-gray-400 transition-all duration-100 ease-in'/>
      ))}
    </div>
    </div>
  )
